...
@section('content')
    <div class="content-wrapper">
        <div class="card">
            <div class="p-3">
                <a href="{{ route('bank.create') }}" class="btn btn-primary col-2"> + Bank</a>
            </div>
                        ...
                        <tbody class="table-border-bottom-0">
                            @foreach ($bank as $b)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('bank.edit', $b->id_bank) }}" class="btn btn-icon btn-outline-warning">
                                            <i class='bx bxs-pencil'></i>
                                        </a>
                                        <form action="{{ route('bank.destroy', $b->id_bank) }}" method="POST" class="d-inline">
                                            @csrf
                                            @method('DELETE')
