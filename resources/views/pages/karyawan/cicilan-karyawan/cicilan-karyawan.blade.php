        ...
        <div class="col-xl-12">
            <div class="nav-align-top mb-4">
                ...
                <div class="tab-pane fade" id="navs-pills-top-profile" role="tabpanel">
                            ...
                            <div class="card border">
                                <div class="card-body">
                                    ...
                                    <div class="row text-sm">
                                        ...
                                        <div class="col-md-6 mb-2">
                                            <strong class="text-black">Tanggal Pembayaran</strong><br>
                                            <span class="text-muted">
                                                {{ $c->pembayaranPinjaman->first()->tanggal_pembayaran }}
                                            </span>
                                        </div>
                                    </div>
                                </div>
                    ...
                    @endforeach
                    @if ($cicilanLunas->count() == 0)
                        <p class="d-flex align-items-center justify-content-center">Tidak ada data cicilan yang lunas</p>
                    @endif
                </div>
