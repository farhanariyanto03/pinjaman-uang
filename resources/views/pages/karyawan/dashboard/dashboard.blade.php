                    ...
                    <div class="d-flex align-items-end row">
                        <div class="col-sm-7">
                            <div class="card-body">
                                ...
                                <p class="mb-4">
                                    Selamat datang di halaman dashboard karyawan, dari sini anda dapat mengatur dan mengelola
                    ...
                    <div class="col-lg-4 col-md-12 col-6 mb-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h3 class="card-title text-nowrap mb-1">{{ $pinjamanLunas }}</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-12 col-6 mb-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h3 class="card-title text-nowrap mb-1">{{ $pinjamanDitolak }}</h3>
                            </div>
                        </div>
                    </div>
                </div>
